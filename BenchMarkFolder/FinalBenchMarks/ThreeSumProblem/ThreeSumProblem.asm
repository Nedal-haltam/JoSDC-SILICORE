...
Main:	
	addi $29, $0, 4000  # Initialize the stack pointer
	#addi $29, $0, 16000
...
inner_loop:
	...
	beq $1, $0, next_i
   	...
   	#sll $23, $16, 2
    	...
    	lw $14, 0($13)           
    	add $15, $19, $22        
   	add $15, $15, $14        # total = numbers[i] + numbers[left] + numbers[right]
...
Mergesort: 	
	...
	sw $6, 1($29)        	# high
	#sw $6, 4($29)
	add $16, $5, $6	        # mid = low + high
	srl $16, $16, 1		# mid = (low + high) / 2
	sw $16, 0($29) 					
	add $6, $16, $0 	
	jal Mergesort		
	lw $16, 0($29)		
