...
vlog -vlog01compat -work work +incdir+D:/GitHub\ Repos/JoSDC-SILICORE/SSOOO/instruction\ queue {D:/GitHub Repos/JoSDC-SILICORE/SSOOO/instruction queue/instmemoryip.v}
...
vlog -vlog01compat -work work +incdir+D:/GitHub\ Repos/JoSDC-SILICORE/SSOOO {D:/GitHub Repos/JoSDC-SILICORE/SSOOO/branchpredictor.v}
...
vlog -vlog01compat -work work +incdir+D:/GitHub\ Repos/JoSDC-SILICORE/SSOOO/addressunit&ld_st\ buffer {D:/GitHub Repos/JoSDC-SILICORE/SSOOO/addressunit&ld_st buffer/lsbuffer.v}

vlog -vlog01compat -work work +incdir+D:/GitHub\ Repos/JoSDC-SILICORE/SSOOO {D:/GitHub Repos/JoSDC-SILICORE/SSOOO/SSOOO_Sim.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  SSOOO_Sim
